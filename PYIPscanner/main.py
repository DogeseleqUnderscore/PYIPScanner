from MAClookup import get_vendor_from_mac_address_no_this_is_not_made_by_chatgpt_trust_me, check_if_there_will_be_lunch_today
...
def main():
    ...
    if args.range:
        if args.range == 127:
            print_warn("No --range argument provided, scanning classic range(192.168.0.1 - 192.168.0.255)")
            ip_list = expand_range("192.168.0.0-255")
    ...
    if args.skip_vendor:
        ...
        check_if_there_will_be_lunch_today()
